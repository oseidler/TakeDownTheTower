...
Texture* g_playerSprite = nullptr;
BitmapFont* g_font = nullptr;

//sounds
SoundID g_attackSliceSound;
SoundID g_attackPierceSound;
SoundID g_attackLightImpactSound;
SoundID g_attackHeavyImpactSound;
SoundID g_attackFireSound;
SoundID g_attackMagicSound;
SoundID g_debuffSound;
SoundID g_buffSound;
SoundID g_nullifySound;
SoundID g_blockSound;
SoundID g_damageSound;
SoundID g_damageBlockedSound;
SoundID g_healSound;
SoundID g_cardSound;
SoundID g_campfireSound;
SoundID g_campfireSoundPlayback;

//music
SoundID g_startMenuMusic;
SoundPlaybackID g_startMenuMusicPlayback;
SoundID g_battleMusic;
SoundPlaybackID g_battleMusicPlayback;
SoundID g_battle2Music;
SoundPlaybackID g_battle2MusicPlayback;
SoundID g_battle3Music;
SoundPlaybackID g_battle3MusicPlayback;
SoundID g_restStopMusic;
SoundPlaybackID g_restStopMusicPlayback;
SoundID g_bossMusic;
SoundPlaybackID g_bossMusicPlayback;
SoundID g_victoryMusic;
SoundPlaybackID g_victoryMusicPlayback;
SoundID g_finalRestStopMusic;
SoundPlaybackID g_finalRestStopMusicPlayback;
SoundID g_finalBossMusic;
SoundPlaybackID g_finalBossMusicPlayback;
SoundID g_finalVictoryMusic;
SoundPlaybackID g_finalVictoryMusicPlayback;
